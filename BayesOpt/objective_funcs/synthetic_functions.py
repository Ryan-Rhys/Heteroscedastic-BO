...
def branin_function(x1, x2, noise=0.0, heteroscedastic=False, f_plot=False):
    ...
    if f_plot:
        ...
        CB = plt.colorbar(CS, shrink=0.8, ticks=[0, 1.6, 3.2, 4.8], extend='both')
        CB.ax.tick_params(labelsize=22)
        plt.xlabel('x1', fontsize=24)
        plt.ylabel('x2', fontsize=24)
        plt.yticks([0.2, 0.4, 0.6, 0.8])
        ...
        CB = plt.colorbar(CS, shrink=0.8, ticks=[0, 4, 8, 12, 16], extend='both')
        CB.ax.tick_params(labelsize=22)
        plt.xlabel('x1', fontsize=24)
        plt.ylabel('x2', fontsize=24)
        plt.yticks([0.2, 0.4, 0.6, 0.8])
        ...
        CB = plt.colorbar(CS, shrink=0.8, ticks=[0, 5, 10, 15, 20], extend='both')
        CB.ax.tick_params(labelsize=22)
        #CB.ax.set_yticklabels(['5', '10', '15'])
        plt.xlabel('x1', fontsize=24)
        plt.ylabel('x2', fontsize=24)
        plt.yticks([0.2, 0.4, 0.6, 0.8])
        plt.xticks([0.2, 0.4, 0.6, 0.8])
