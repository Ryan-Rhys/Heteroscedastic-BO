...
def main(dataset, fplot):
    ...
    l_init = 50  # lengthscale to initialise the optimiser with
    sigma_f_init = 0.1  # signal amplitude to initialise the optimiser with
    noise = 0.2
    ...
    l_noise_init = 0.1
    sigma_f_noise_init = 0.3
    gp2_noise = 0.2  # We optimise this hyperparameter by hand.
    num_iters = 10
    sample_size = 100
    ...
    print(f'Heteroscedastic GP NLPD: {nlpd_val_het}')
