...
from dataset_loaders import williams_1996, silverman_1985, goldberg_1998, yuan_2004, lidar_1994, scallop_data
...
if __name__ == '__main__':
    ...
    xs, ys = lidar_1994(fplot_data=False)
    xs, ys = silverman_1985(fplot_data=False)
    ...
    l_init = 127  # lengthscale to initialise the optimiser with
    sigma_f_init = 10  # signal amplitude to initialise the optimiser with
    noise = 0.45
    ...
    l_noise_init = 387
    sigma_f_noise_init = 2.84
    gp2_noise = 3.97  # We optimise this hyperparameter by hand.
    num_iters = 10
    sample_size = 100
