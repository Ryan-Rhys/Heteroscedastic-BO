...
if __name__ == '__main__':
    ...
    plt.legend(loc=4)
    plt.savefig('freesolv_figures/bayesopt_plot{}_iters_{}_random_trials_and_init_num_samples_of_{}_and_seed_{}_new_acq_penalty_is_{}'.
    ...
    plt.legend(loc=1)
    plt.savefig('freesolv_figures/bayesopt_plot{}_iters_{}_random_trials_and_init_num_samples_of_{}_and_seed_{}_noise_only_new_acq_penalty_is_{}'.
                format(bayes_opt_iters, random_trials, init_num_samples, numpy_seed, penalty))